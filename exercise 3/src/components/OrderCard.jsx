...
export default function OrderCard({product, productPrice, quantity, onQuantityChanged}) {
  ...
  return (
    <div className="order">
      ...
      <div className="order-quantity">
        <div className="order-button" style={removeQuantityButtonStyle()} onClick={removeQuantity}>-</div>
        <h4>{quantity}</h4>
        <div className="order-button" onClick={addQuantity}>+</div>
      </div>
    </div>
  );
}